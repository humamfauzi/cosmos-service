...
import (
  ...
  "github.com/cosmos/cosmos-sdk/codec"
	...
	"github.com/humamfauzi/appservice"
...
type appserviceApp struct {
  *bam.BaseApp
  ...
  keyASnames       *sdk.KVStoreKey
  keyASowners      *sdk.KVStoreKey
  keyASprices      *sdk.KVStoreKey
  keyFeeCollection *sdk.KVStoreKey

  accountKeeper auth.AccountKeeper
  bankKeeper bank.Keeper
  feeCollectionKeeper auth.FeeCollectionKeeper
  asKeeper appservice.keeper
}

func NewnappserviceApp(logger log.Logger, db dbm.DB) *nameserviceApp {
